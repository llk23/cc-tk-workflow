...
export interface TriggerConfig {
  ...
  cron?: string;          // cron 表达式（定时触发）
  webhookUrl?: string;    // webhook URL（webhook 触发）
  eventFilter?: Record<string, unknown>; // 事件过滤条件
}
...
export enum NodeTypeEnum {
  ...
  AI_ANALYZE_WORKBUDDY_AGENT = 'ai-analyze-workbuddy-agent',
